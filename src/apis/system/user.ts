...
export const loginRequest = (userInfo: RequestParams) => {
  return https(false).request<LoginModel>(
    'login',
    Method.POST,
    userInfo,
    ContentType.json
...
export const userInfoRequest = () => {
  return https().request<UserInfoModel<UserDesc>>(
    'getInfo',
    Method.GET,
    undefined,
    ContentType.form
...
export const getUser = (userId?: any) => {
  return https().request<any>(
    `system/user/${praseStrEmpty(userId)}`,
    Method.GET,
    undefined,
    ContentType.form
  )
...
export const updateUserPwd = (
  oldPassword: string | number | undefined,
