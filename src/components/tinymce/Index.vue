    ...
    const initOptions = ref({
      ...
      language_url:
        store.state.app.language === 'en'
          ? ''
          : `${import.meta.env.BASE_URL}tinymce/langs/${store.state.app.language}.js`,
      language: 'zh_CN',
      // eslint-disable-next-line @typescript-eslint/camelcase
      // eslint-disable-next-line @typescript-eslint/camelcase
      skin_url: `${import.meta.env.BASE_URL}tinymce/skins/`,
      // eslint-disable-next-line @typescript-eslint/camelcase
      emoticons_database_url: `${import.meta.env.BASE_URL}tinymce/emojis.min.js`,
      // eslint-disable-next-line @typescript-eslint/camelcase
