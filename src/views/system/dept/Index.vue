          ...
          <el-col :span="24">
            ...
            >
              <Treeselect
                ...
                placeholder="请选择上级部门"
              />
              <!-- <treeselect-value :value="parentId" /> -->
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item
  ...
  setup() {
    ...
    const getList = () => {
      ...
      listDept(dataMap.queryParams).then((response: any) => {
        ...
        dataMap.defaultExpandedKeys.push(
          (dataMap.deptList[0] as any)?.deptId + ''
        )
    ...
    const handleAdd = async (row: any) => {
      dataMap.deptName = ''
      dataMap.deptId = undefined
      dataMap.parentId = undefined
      dataMap.orderNum = 0
      dataMap.leader = ''
      dataMap.phone = ''
      dataMap.email = ''
    ...
    const handleUpdate = async (row: any) => {
      ...
      if (result?.code === 200) {
        ...
        dataMap.parentId = result.data.parentId
          ...
          : undefined
        dataMap.orderNum = Number(result.data.orderNum)
