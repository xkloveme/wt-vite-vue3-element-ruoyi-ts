 ...
 * @LastEditTime: 2021-10-15 17:11:12
 */
...
const componentsRouter: Array<RouteRecordRaw> = [
  {
    ...
    children: [
      ...
      },
      {
        path: 'back-to-top',
        component: () =>
          import(/* webpackChunkName: "BackToTop" */ '@/views/components-demo/BackToTopDemo.vue'),
        name: 'BackToTopDemo',
        meta: {
          title: 'backToTop',
          noCache: true
      ...
      },
      {
        path: 'draggable-list',
        component: () =>
          import(/* webpackChunkName: "CountTo" */ '@/views/components-demo/DraggableListDemo.vue'),
      ...
      },
      {
        ...
        component: () =>
          import(/* webpackChunkName: "CountTo" */ '@/views/components-demo/DraggableSelectDemo.vue'),
